  ...
  180 PROC_LOAD_BITMAP("/tree.rgb",0,16,16) : REM CALL PROC_LOAD_BITMAP (n,w,h).
  190 REM PROC_LOAD_BITMAP("/tree.rgb",1,16,16) : REM CALL PROC_LOAD_BITMAP (n,w,h).
 ...
 1070 :
 1100 REM GAME LOOP.
 1111 PRINT TAB(20,20);"hello"
 1110 A%=INKEY(0) : REM GET KEYBOARD INPUT FROM PLAYER.
 1120 IF A%=21 THEN X%=X%+1 : REM 21 RIGHT ARROW KEY & NEXT FRAME.
