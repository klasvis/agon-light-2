  ...
  170 PROC_LOAD_SPRITE("/tree.rgb",0,16,16) : REM CALL PROC_LOAD_SPRITE WITH SPRITE (n,w,h).
 ...
 1200 
 1220   VDU 23,27,13,10;10;  : REM MOVE CURRENT SPRITE TO POS X,Y (created by X loop).
 1221 REM  VDU 23,27,15       : REM UPDATE THE SPRITES IN THE GPU.
 1222   VDU 23,27,13,26;10;  : REM MOVE CURRENT SPRITE TO POS X,Y (created by X loop).
 1223   VDU 23,27,15       : REM UPDATE THE SPRITES IN THE GPU.
