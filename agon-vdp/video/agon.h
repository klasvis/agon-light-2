...
#define VDP_WIFI				0xF1	// WiFi configuration & status
...
#define VDP_VGAMODE				0xFD	// Switch physical VGA generation on and off
#define VDP_TEKTRONIX			0xFC	// Tektronix 4014 vector graphics control
